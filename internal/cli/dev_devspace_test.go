...
func TestDevCmd_DevspaceFlag_CreatesFile(t *testing.T) {
	...
	err := runDev(runDevParams{Devspace: true, Cmd: cmd, NoTunnel: true})
...
func TestDevCmd_DevspaceFlag_InjectsServiceName(t *testing.T) {
	...
	err := runDev(runDevParams{Service: "custom-app", Devspace: true, Cmd: cmd, NoTunnel: true})
	require.NoError(t, err)
...
func TestDevCmd_DevspaceFlag_ValidYaml(t *testing.T) {
	...
	err := runDev(runDevParams{Service: "test-app", Devspace: true, Cmd: cmd, NoTunnel: true})
	require.NoError(t, err)
